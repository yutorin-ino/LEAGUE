/**
 * generate_grommet_1300_dashboard.js
 * The Grommet専用・No.1〜1300独立ダッシュボード生成（スタンドアロンHTML・XLSX不要）
 * node generate_grommet_1300_dashboard.js
 */

const fs = require('fs');
const GROMMET_1300 = require('./grommet_1300.js');

const OUTPUT = "C:\\Users\\hiro\\Desktop\\LEAGUE\\grommet_1300_dashboard.html";
...
console.log("grommet_1300.js 読み込み中...");

const products = [];
for (const row of GROMMET_1300) {
  const no       = row[0];
...
console.log(`The Grommet 1300 製品数: ${products.length} 件 / メールあり: ${emailCount} 件`);
...
<title>🟢 The Grommet No.1-1300 専用ダッシュボード</title>
<style>
...
<header>
  <div class="h-top">
    ...
    <h1>The Grommet No.1-1300 専用ダッシュボード — 独立採番・厳選アメリカ製品キュレーション</h1>
  </div>
  <div class="h-stats">
